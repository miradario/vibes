...
> = {
  ...
  hiddenPathIndexes: [
    ...
    10, 11,
    98,
    99, 100, 101, 102, 103, 104, 105, 111, 113,
    106, 107, 108, 109, 110, 112, 114,
  ],
  drawSegments: [
    { pathIndex: 17, dash: 48000, startAt: 0, span: 0.5, strokeWidth: 2.1 },
    { pathIndex: 37, dash: 18000, startAt: 0.5, span: 0.28, strokeWidth: 1.9 },
    { pathIndex: 44, dash: 12000, startAt: 0.78, span: 0.14, strokeWidth: 1.9 },
    { pathIndex: 115, dash: 10000, startAt: 0.92, span: 0.08, strokeWidth: 1.7 },
  ],
  butterflies: [
    {
      pathIndexes: [106, 107, 109, 112, 114],
  ...
  showPenTip: true,
  penPath: {
    inputRange: [0, 0.5, 0.78, 0.92, 1],
    x: [870, 700, 720, 980, 1240],
    y: [700, 1180, 1420, 1160, 1250],
    size: 8,
    color: vibesTheme.colors.accentCoral,
  },
};
