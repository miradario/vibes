...
const baseTranslations = {
  es: {
    ...
    update: {
      forceEyebrow: "Nueva versión disponible",
      suggestedEyebrow: "Nueva versión disponible",
      forceTitle: "Hay una nueva versión de Vibes esperándote",
      suggestedTitle: "Hay una versión más nueva de Vibes",
      forceBody:
        "Actualizá la app para seguir disfrutando una experiencia más estable y cuidada.",
      suggestedBody:
        "Incluye mejoras para que la experiencia se sienta más fluida.",
      currentVersion: "Versión actual",
      targetVersion: "Versión recomendada",
      updateNow: "Actualizar Vibes",
      later: "Más tarde",
    },
    tabs: {
      discover: "Descubrir",
    ...
    discover: {
      ...
      title: "Descubrir",
      filters: "Filtros",
      filtersSubtitle: "Ajustá los perfiles que querés descubrir.",
      age: "Edad",
      distance: "Distancia",
      gender: "Género",
      genderWoman: "Mujer",
      ...
      dietNonVegetarian: "No vegetariano",
      dietOther: "Otro",
      smoking: "Fuma",
      clear: "Limpiar",
      apply: "Aplicar",
    ...
    resetPassword: {
      ...
      subtitle: "Usá una clave segura para volver a entrar a Vibes.",
      ...
      successMessage: "Ya podés entrar con tu nueva contraseña.",
      successPrimary: "Continuar",
    },
    signup: {
      switchPrompt: "¿Ya tenés cuenta?",
      switchAction: "Iniciá sesión",
    ...
    onboarding: {
      ...
      countrySubtitle:
        "Podés escribir tu ciudad o usar tu ubicación una sola vez",
      cityPlaceholder: "Ingresá tu ciudad",
    ...
    profile: {
      ...
      deleteAccountMessage:
        "Vas a ser redirigido al sitio oficial de Vibes para iniciar la eliminación permanente de tu cuenta y tus datos personales.",
      deleteAccountCancel: "Cancelar",
      deleteAccountConfirm: "Continuar",
    ...
    home: {
      ...
      guruCardEyebrow: "GURU VIBES · PARA VOS",
      guruGuideOpen: "Ver mi guía de hoy",
      guruGuideEyebrow: "TU GUÍA DE HOY",
      guruGuideActionsTitle: "Para llevarlo a tu día",
      guruGuideStart: "Empezar mi día",
      guruGuideClose: "Cerrar guía",
      eventNoParticipants: "Todavía no hay participantes",
      eventOneParticipant: "1 participante",
      eventParticipantCount: "{{count}} participantes",
      guruDismiss: "Ocultar por hoy",
      challengeCheckedInTodayOne: "{{count}} completo hoy",
      challengeCheckedInToday: "{{count}} completaron hoy",
  ...
  en: {
    ...
    update: {
      forceEyebrow: "New version available",
      suggestedEyebrow: "New version available",
      forceTitle: "A new version of Vibes is waiting for you",
      suggestedTitle: "There is a newer version of Vibes",
      forceBody:
        "Update the app to keep enjoying a more stable and cared-for experience.",
      suggestedBody:
        "It includes improvements that help the experience feel smoother.",
      currentVersion: "Current version",
      targetVersion: "Recommended version",
      updateNow: "Update Vibes",
      later: "Later",
    },
    tabs: {
      discover: "Discover",
    ...
    discover: {
      ...
      title: "Discover",
      filters: "Filters",
      filtersSubtitle: "Choose which profiles you want to discover.",
      age: "Age",
      distance: "Distance",
      gender: "Gender",
      genderWoman: "Woman",
    ...
    login: {
      ...
      resetPasswordMissingEmail: "Enter your email to recover your password.",
    ...
    resetPassword: {
      ...
      subtitle: "Use a secure password to get back into Vibes.",
    ...
    onboarding: {
      ...
      countrySubtitle:
        "Enter your city or use your location once",
    ...
    vibesOnboarding: {
      ...
      location: {
        ...
        subtitle: "Enter your city or use your location once",
        button: "Next",
      },
      practices: {
    ...
    profile: {
      ...
      deleteAccountMessage:
        "You will be redirected to the official Vibes website to start the permanent deletion of your account and personal data.",
    ...
    home: {
      ...
      guruCardEyebrow: "VIBES GURU · FOR YOU",
      guruGuideOpen: "See my guide for today",
      guruGuideEyebrow: "YOUR GUIDE FOR TODAY",
      guruGuideActionsTitle: "Bring it into your day",
      guruGuideStart: "Start my day",
      guruGuideClose: "Close guide",
      eventNoParticipants: "No participants yet",
      eventOneParticipant: "1 participant",
      eventParticipantCount: "{{count}} participants",
      guruDismiss: "Hide for today",
      challengeCheckedInTodayOne: "{{count}} checked in today",
