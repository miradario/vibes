...
const translations = {
  es: {
    ...
    events: {
      challenges: "Challenges",
      events: "Eventos",
      searchChallenges: "Buscar challenges...",
      searchEvents: "Buscar eventos...",
      create: "Crear",
      loadingChallenges: "Cargando challenges...",
      loadingEvents: "Cargando eventos...",
      loadChallengesError: "No se pudieron cargar los challenges.",
      loadEventsError: "No se pudieron cargar los eventos.",
      couldNotLoad: "No se pudieron cargar",
      noChallengesYet: "Todavía no hay challenges reales",
      noEventsYet: "Todavía no hay eventos reales",
      queryingSupabase: "Consultando Supabase...",
      challengesEmpty: "Creá un challenge o conectá una fuente real para poblar esta lista.",
    ...
    home: {
      ...
      yesSmoking: "Sí fuma",
      filtersDefault: "Edad, género, distancia",
  ...
  en: {
    ...
    home: {
      ...
      yesSmoking: "Smokes",
      filtersDefault: "Age, gender, distance",
