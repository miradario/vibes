...
export const challengeMediaPresets: ChallengeMediaPreset[] = [
  {
    ...
    video: require("../../assets/videos/surfaces/challenges/VibesHome/VibesHome.mp4"),
    progressVideos: [
      require("../../assets/videos/surfaces/challenges/VibesHome/VibesHome_part_01.mp4"),
      require("../../assets/videos/surfaces/challenges/VibesHome/VibesHome_part_02.mp4"),
      require("../../assets/videos/surfaces/challenges/VibesHome/VibesHome_part_03.mp4"),
      require("../../assets/videos/surfaces/challenges/VibesHome/VibesHome_part_04.mp4"),
      require("../../assets/videos/surfaces/challenges/VibesHome/VibesHome_part_05.mp4"),
    ],
  },
  {
    id: "welcome",
    label: "Bienvenida",
    image: require("../../assets/images/challenges/vibesLogo.png"),
    video: require("../../assets/videos/surfaces/bienvenidx.mp4"),
  },
  {
    id: "challenge",
    label: "Desafío",
    image: require("../../assets/images/challenges/challengetree.png"),
    video: require("../../assets/videos/surfaces/challenge.mp4"),
  },
  {
    id: "events",
    label: "Evento",
    image: require("../../assets/images/challenges/events.png"),
    video: require("../../assets/videos/surfaces/challenges/events/events.mp4"),
    progressVideos: [
      require("../../assets/videos/surfaces/challenges/events/events_part_01.mp4"),
      require("../../assets/videos/surfaces/challenges/events/events_part_02.mp4"),
      require("../../assets/videos/surfaces/challenges/events/events_part_03.mp4"),
      require("../../assets/videos/surfaces/challenges/events/events_part_04.mp4"),
      require("../../assets/videos/surfaces/challenges/events/events_part_05.mp4"),
    ],
  },
  {
    id: "name",
    ...
    video: require("../../assets/videos/surfaces/challenges/name/name.mp4"),
    progressVideos: [
      require("../../assets/videos/surfaces/challenges/name/name_part_01.mp4"),
      require("../../assets/videos/surfaces/challenges/name/name_part_02.mp4"),
      require("../../assets/videos/surfaces/challenges/name/name_part_03.mp4"),
      require("../../assets/videos/surfaces/challenges/name/name_part_04.mp4"),
      require("../../assets/videos/surfaces/challenges/name/name_part_05.mp4"),
    ],
  },
  {
    id: "signup",
    ...
    video: require("../../assets/videos/surfaces/signup.mp4"),
  },
  {
    id: "login",
    label: "Login",
    image: require("../../assets/images/challenges/login.png"),
    video: require("../../assets/videos/surfaces/challenges/login/login.mp4"),
    progressVideos: [
      require("../../assets/videos/surfaces/challenges/login/login_part_01.mp4"),
      require("../../assets/videos/surfaces/challenges/login/login_part_02.mp4"),
      require("../../assets/videos/surfaces/challenges/login/login_part_03.mp4"),
      require("../../assets/videos/surfaces/challenges/login/login_part_04.mp4"),
      require("../../assets/videos/surfaces/challenges/login/login_part_05.mp4"),
    ],
  },
];
