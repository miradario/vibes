...
import { Home, Matches, Messages, Profile, Meditations, Welcome, Videos, Events, EditProfile, Premium, Chat, Settings, PreferenceDetail, OnboardingGender, OnboardingOrientation, OnboardingInterested } from "./screens";
